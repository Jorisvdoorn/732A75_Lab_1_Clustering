...
Although it is hard to determine exactly what the impact of the standard deviation is on the model, because we do not have access to the actual equations, we suspect that an increase in the standard deviation will correspond with more unequal clusters. In other words, from the graphs we obtained we see that one of the clusters covers more observations as the standard deviation increases
